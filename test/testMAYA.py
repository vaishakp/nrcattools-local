...
class TestMaya(unittest.TestCase):
    ...
    def test_waveforms(self):
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The RMS error between the + components of the waveforms must be almost 0",
        )
        self.assertAlmostEqual(
            Res_x,
            0,
            prec,
            f"The RMS error between the x components of the waveforms must be almost 0",
        )
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The maximum lower deviation between the + components of the waveforms must be almost 0",
        )
        self.assertAlmostEqual(
            np.absolute(Amin_p),
            0,
            prec,
            f"The maximum lower deviation between the x components of the waveforms must be almost 0",
        )
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The mismatch between the + components of the waveforms must be almost 0",
        )
        self.assertAlmostEqual(
            mismatch_p,
            0,
            prec,
            f"The mismatch between the x components of the waveforms must be almost 0",
        )
