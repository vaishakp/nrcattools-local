...
taxis, hp2, hx2 = wfa1.to_td_waveform(
    Mtotal=M, distance=D, incl_angle=inc, delta_t=delta_t
)
...
class TestSXS(unittest.TestCase):
    ...
    def test_waveforms(self):
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The RMS error between the + components of the waveforms must be atmost 0.1 times Max amplitude of the normalized waveform",
        )
        self.assertAlmostEqual(
            Res_x,
            0,
            prec,
            f"The RMS error between the x components of the waveforms must be almost 0.1 times Max amplitude of the normalized waveform",
        )
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The maximum lower deviation between the + components of the waveforms must be almost 100%",
        )
        self.assertAlmostEqual(
            np.absolute(Amax_p),
            0,
            prec,
            f"The maximum upper deviation between the x components of the waveforms must be almost 100%",
        )
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The maximum upper deviation between the + components of the waveforms must be almost 0",
        )
        self.assertAlmostEqual(
            np.absolute(Amax_p),
            0,
            prec,
            f"The maximum upper deviation between the x components of the waveforms must be almost 0",
        )
        ...
        self.assertAlmostEqual(
            ...
            0,
            prec,
            f"The mismatch between the + components of the waveforms must be almost 0.1%",
        )
        self.assertAlmostEqual(
            mismatch_p,
            0,
            prec,
            f"The mismatch between the x components of the waveforms must be almost 0.1%",
        )
